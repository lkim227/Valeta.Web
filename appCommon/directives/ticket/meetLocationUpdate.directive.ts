module AppCommon {
    ...
    export interface IMeetLocationUpdateAttributes extends ng.IAttributes {
        canUpdate: string;
        reloadOnSave: string;
    }

    export interface IMeetLocationUpdateScope extends ng.IScope {
    ...
    class MeetLocationUpdateDirective implements ng.IDirective {
        restrict = "E";
        templateUrl = "/appCommon/directives/ticket/meetLocationUpdate.directive.html";
        scope = {
            ticketIdentifier: "=",
            isTicketActive: "=",
            textData: "=",
        ...
        link: ng.IDirectiveLinkFn = (scope: IMeetLocationUpdateScope, elements: ng.IAugmentedJQuery, attrs: IMeetLocationUpdateAttributes, ngModelCtrl: ng.INgModelController) => {
            var self = this;
    ...
    angular.module("app.common")
        .directive("meetLocationUpdate",
        [
            "$state", "$timeout", "SessionService", "ValetServiceCommand",
            (s, t, ss, v) => new MeetLocationUpdateDirective(s, t, ss, v)
        ]);
}